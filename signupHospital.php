<!DOCTYPE html>
<!-- <?php include_once 'connectionhos.php'; ?> -->
<html>
<head>
<title>Hospital Staff SignUp</title>
...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
     ...
     <div class="col-sm-4">
      <h3 class=" text-info text-center font-weight-bold my-3">Sign Up</h3>
    </div>
     <div class="col-sm-4">
    </div>
  </div>
   ...
   if($passwordConfirm ==''){
        ...
        if($password != $passwordConfirm){
         ...
         if(strlen($password)>20){ // Max 
          ...
          $sql="select * from hospital where (uname='$username' or email='$email');";
...
$row = mysqli_fetch_assoc($res);
    ...
    $password = password_hash($password,PASSWORD_BCRYPT);
           ...
           $result = mysqli_query($con,"INSERT into hospital values('','$fname','$lname','$username','$email','$password')");
